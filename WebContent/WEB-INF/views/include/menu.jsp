...
<div class="menu">
	<ul>
		...
		<li class="chapter">Ch10. <a href="<%=application.getContextPath()%>/ch10/content">Controller - Execution Handling </a></li>
		...
		<li class="chapter">Ch13. <a href="<%=application.getContextPath()%>/ch13/content">View - DI </a></li>
		<li class="chapter">Ch14. <a href="<%=application.getContextPath()%>/ch14/content">Data Access Object </a></li>
	</ul>
</div>
